...
function Footer() {
  ...
  return (
    ...
    backdrop-blur-2xl border border-white/10 px-8 py-8 shadow-[0_25px_60px_rgba(0,0,0,0.7)]'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
            ...
            style={{ transformStyle: "preserve-3d"}}>
                ...
                style={{ transform: "translateZ(20px)"}}>
                    ...
                    <span className='text-lg font-semibold bg-gradient-to-br from-white via-gray-300
                ...
                <p className='text-sm text-gray-300 max-w-sm'>
                    ExamNotes AI helps students genrate exm-focused notes, revision material, diagrams, and printable PDFs using AI</p>
            ...
            <div className='text-center'>
                ...
                <ul className='space-y-2 text-sm'>
                    <li onClick={()=>navigate("/notes")} className='text-gray-300 hover:text-white transition-colors'>
                        ...
                        <li onClick={()=>navigate("/history")} className='text-gray-300 hover:text-white'>
                            History
                        </li>
                        <li onClick={()=>navigate("/pricing")} className='text-gray-300 hover:text-white'>
                            Add Credits
                        </li>
                </ul>
            </div>
        ...
        <p className='text-center text-xs text-gray-500'>
            0 {new Date().getFullYear()} ExamNotes AI. All rights reserved.
